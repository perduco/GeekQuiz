...
namespace GeekQuiz.App_Start
{
    ...
    class B2CConfigurationManager : ConfigurationManager<OpenIdConnectConfiguration>
    {
        ...
        public B2CConfigurationManager(string metadataAddress)
            : this(metadataAddress, new HttpDocumentRetriever())
        {
        }

        public B2CConfigurationManager(string metadataAddress, IDocumentRetriever docRetriever) : base (metadataAddress, docRetriever)
        {
