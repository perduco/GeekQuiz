...
namespace GeekQuiz.App_Start
{
    ...
    public class B2COpenIdConnectAuthenticationHandler : OpenIdConnectAuthenticationHandler
    {
        ...
        public B2COpenIdConnectAuthenticationHandler(ILogger logger) : base(logger)
        {
            _logger = logger;
        }
